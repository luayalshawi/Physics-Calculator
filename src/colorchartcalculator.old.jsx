...
module.exports = React.createClass({
  ...
  setColor:function(index,logic,color)
  {
    ...
    if(logic == true)
    {
      ...
      selected.push(color);
      this.setState({s:tmp,selectedColors:selected});
      // console.log(selected);
    }
    else {
      tmp[index] = color;
      var newSelected = this.remvoveFrom(selected,color);
      this.setState({s:tmp,selectedColors:newSelected});
    ...
    if(colors.length > 2)
    {
      ...
      console.log("tolerance color: " + tolerance);
      console.log("multiplier color: " + multiplier);
      var result = parseInt(totalFigure) * multiplier;
      console.log(result);
      this.setState({result:result});


      // console.log( this.resistorMapedValue(figure1).value );
      // console.log( this.resistorMapedValue(figure2).value );
      // console.log( this.resistorMapedValue(multiplier).multiplier );
      // var v1,v2,tes;
      // v1 = this.resistorMapedValue(figure1).value;
      // v2 = this.resistorMapedValue(figure2).value;
      // tes = v1 + "" +v2;
      // var mult =  this.resistorMapedValue(multiplier).multiplier;
      // var r = parseInt(tes) * mult;
      // console.log(r);
